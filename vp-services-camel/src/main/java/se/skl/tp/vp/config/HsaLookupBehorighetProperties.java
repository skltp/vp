...
@ConfigurationProperties(prefix = "hsa.lookup.behorighet")
public class HsaLookupBehorighetProperties implements HsaLookupConfiguration {
  /**
   * Is HSA lookup active by default (for authorization)?
   */
