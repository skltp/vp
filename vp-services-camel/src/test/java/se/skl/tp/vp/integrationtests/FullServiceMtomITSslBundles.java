...
@CamelSpringBootTest
@SpringBootTest(properties = { "tp.tls.store.consumer.bundle=cons", "tp.tls.store.producer.bundle=prod"})
@DirtiesContext(classMode = ClassMode.AFTER_CLASS)
@StartTakService
public class FullServiceMtomITSslBundles extends LeakDetectionBaseTest {
