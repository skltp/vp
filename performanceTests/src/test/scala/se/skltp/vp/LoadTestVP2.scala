...
class LoadTestVP2 extends Simulation {
  ...
  setUp(
    ...
    Scenarios.scn_PingForConfigurationHttpsOk.inject(rampUsers(Conf.noOfUsers) over (Scenarios.rampUpTimeSecs seconds)).protocols(Conf.httpConf),
