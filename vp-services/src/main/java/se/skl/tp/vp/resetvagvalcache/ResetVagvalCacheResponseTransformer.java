...
public class ResetVagvalCacheResponseTransformer extends AbstractTransformer {

	private static final Logger log = LoggerFactory.getLogger(ResetVagvalCacheResponseTransformer.class);
