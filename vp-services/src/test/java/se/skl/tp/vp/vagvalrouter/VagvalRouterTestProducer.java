...
public class VagvalRouterTestProducer {
	...
	private static final Logger log = LoggerFactory.getLogger(VagvalRouterTestProducer.class);
    ...
    public Object process(String csvRequest) {
		...
		log.info("VagvalRouterTestReceiver received the request: {}", csvRequest);
