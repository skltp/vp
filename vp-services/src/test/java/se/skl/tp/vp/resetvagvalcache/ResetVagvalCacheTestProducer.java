...
public class ResetVagvalCacheTestProducer {
	...
	private static final Logger log = LoggerFactory.getLogger(ResetVagvalCacheTestProducer.class);
    ...
    public Object process(String csvRequest) {
		...
		log.info("ResetVagvalCacheTestReceiver received the request: {}", csvRequest);
