...
public class ResetVagvalCacheTestConsumer {

	private static final Logger log = LoggerFactory.getLogger(ResetVagvalCacheTestConsumer.class);

	public static final String DEFAULT_SERVICE_ADDRESS = null;//getAddressForServletTransport("RESETVAGVALCACHE_INBOUND_URI");
	...
	private static void executeTestCall(String personnummer, String serviceAddress) throws Fault {
		ResetVagvalCacheTestConsumer consumer = new ResetVagvalCacheTestConsumer(serviceAddress);
	...
	public ResetVagvalCacheTestConsumer(String serviceAddress) {
