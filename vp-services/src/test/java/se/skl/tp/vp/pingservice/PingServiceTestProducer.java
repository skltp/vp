...
public class PingServiceTestProducer {
	...
	private static final Logger log = LoggerFactory.getLogger(PingServiceTestProducer.class);
    ...
    public Object process(String csvRequest) {
		...
		log.info("PingServiceTestReceiver received the request: {}", csvRequest);
