...
import static se.skl.tp.vp.pingforconfiguration.PingForConfigurationTestConsumer.DEFAULT_SERVICE_ADDRESS;
import static se.skl.tp.vp.pingforconfiguration.PingForConfigurationTestProducer.TEST_ID_FAULT_INVALID_ID;
import static se.skl.tp.vp.pingforconfiguration.PingForConfigurationTestProducer.TEST_ID_FAULT_TIMEOUT;
import static se.skl.tp.vp.pingforconfiguration.PingForConfigurationTestProducer.TEST_ID_OK;
...
public class PingForConfigurationIntegrationTest extends AbstractTestCaseWithServletEngine {
	
	private static final Logger log = LoggerFactory.getLogger(PingForConfigurationIntegrationTest.class);
	...
	private static final String REQUEST_QUEUE   = rb.getString("PINGFORCONFIGURATION_REQUEST_QUEUE");
	private static final String RESPONSE_QUEUE  = rb.getString("PINGFORCONFIGURATION_RESPONSE_QUEUE");
 
	private static final String ERROR_LOG_QUEUE = "SOITOOLKIT.LOG.ERROR";
	private AbstractJmsTestUtil jmsUtil = null;
	
    public PingForConfigurationIntegrationTest() {
    	
    	// Initialize servlet engine in baseclass with proper values
    	//super(MULE_SERVER_ID, HTTP_PORT, CONTEXT_PATH, MULE_SERVLET_URI);
    	super(MULE_SERVER_ID, -1, "", "");
	...
	protected String getConfigResources() {
		...
		"vp-common.xml," +
		"services/PingForConfiguration-service.xml," +
    ...
    public void test_ok() throws Fault {
    	...
    	PingForConfigurationTestConsumer consumer = new PingForConfigurationTestConsumer(DEFAULT_SERVICE_ADDRESS);
