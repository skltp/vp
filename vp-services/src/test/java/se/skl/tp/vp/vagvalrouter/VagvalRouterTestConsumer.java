...
public class VagvalRouterTestConsumer {

	private static final Logger log = LoggerFactory.getLogger(VagvalRouterTestConsumer.class);

	public static final String DEFAULT_SERVICE_ADDRESS = null;//getAddressForServletTransport("VAGVALROUTER_INBOUND_URI");
	...
	private static void executeTestCall(String personnummer, String serviceAddress) throws Fault {
		VagvalRouterTestConsumer consumer = new VagvalRouterTestConsumer(serviceAddress);
	...
	public VagvalRouterTestConsumer(String serviceAddress) {
