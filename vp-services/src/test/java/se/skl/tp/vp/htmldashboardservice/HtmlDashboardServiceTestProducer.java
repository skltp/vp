...
public class HtmlDashboardServiceTestProducer {
	...
	private static final Logger log = LoggerFactory.getLogger(HtmlDashboardServiceTestProducer.class);
    ...
    public Object process(String csvRequest) {
		...
		log.info("HtmlDashboardServiceTestReceiver received the request: {}", csvRequest);
