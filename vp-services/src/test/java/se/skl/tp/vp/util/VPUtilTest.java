...
public class VPUtilTest {
	...
	public void transformToSoapFault_ok() {
		String cause = "VP004 No Logical Adress found for serviceNamespace:urn:riv:domain:subdomain:GetProductDetail:1:rivtabp20, receiverId:vp-test-producer_kalle";
