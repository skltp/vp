...
public class PingServiceTestConsumer {

	private static final Logger log = LoggerFactory.getLogger(PingServiceTestConsumer.class);

	public static final String DEFAULT_SERVICE_ADDRESS = null;//getAddressForServletTransport("PINGSERVICE_INBOUND_URI");
	...
	private static void executeTestCall(String personnummer, String serviceAddress) throws Fault {
		PingServiceTestConsumer consumer = new PingServiceTestConsumer(serviceAddress);
	...
	public PingServiceTestConsumer(String serviceAddress) {
