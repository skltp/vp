...
import static se.skl.tp.vp.pingservice.PingServiceTestConsumer.DEFAULT_SERVICE_ADDRESS;
import static se.skl.tp.vp.pingservice.PingServiceTestProducer.TEST_ID_FAULT_INVALID_ID;
import static se.skl.tp.vp.pingservice.PingServiceTestProducer.TEST_ID_FAULT_TIMEOUT;
import static se.skl.tp.vp.pingservice.PingServiceTestProducer.TEST_ID_OK;
...
public class PingServiceIntegrationTest extends AbstractTestCaseWithServletEngine {
	...
	private static final String REQUEST_QUEUE   = rb.getString("PINGSERVICE_REQUEST_QUEUE");
	private static final String RESPONSE_QUEUE  = rb.getString("PINGSERVICE_RESPONSE_QUEUE");
 
	private static final String ERROR_LOG_QUEUE = "SOITOOLKIT.LOG.ERROR";
	private AbstractJmsTestUtil jmsUtil = null;
	
    public PingServiceIntegrationTest() {
	...
	protected String getConfigResources() {
		...
		"teststub-services/PingService-teststub-service.xml";
    }
    ...
    public void test_ok() throws Fault {
    	...
    	PingServiceTestConsumer consumer = new PingServiceTestConsumer(DEFAULT_SERVICE_ADDRESS);
